...
for jk in range(10):
    ...
    bf=0
    for tt in range(10):#15):
        #print(tt,'---')
        #img = PIL.Image.open("296.jpg")#PIL.ImageGrab.grab()'
                    ...
                    for i in range(40):
                        ...
                        if tell_color_dis(img.getpixel((pt+i,y+15)),(183,26, 38),104.5609869884557):
                                    ...
                                    while True:
                                        ...
                                        if  g in f:
                                           k7i+=1
                                            ...
                                            img.save(g)
                                            break'''
                                    #print(tell_color_dis(img.getpixel(((pt+i+18+9,y+15-ii-20))),(0,0,0),228.1446909309967),tell_color_dis(img.getpixel((x,y+5)),(145,144,143),60)!=True)
                                    if (tell_color_dis(img.getpixel(((pt+i+18+9,y+15-ii-20))),(0,0,0),228.1446909309967) and
                                        tell_color_dis(img.getpixel((x,y+5)),(145,144,143),60)!=True and
                                        flg3==0):
                            ...
                            if flg6==0 and flg4==1 and flg3==1:
                                print('end2=',((pt+i,y+15)),s*0.009904621704895584)
                                end2=pt+i+15
                                bf+=1
                                break#FOR 40
                            else:
